            ...
            <div className="top-part">
                ...
                <div className="left-part">
                    ...
                    <div className="about">
                        ...
                        <p className="paragraph">
                            Sodales tempor sapien quaerat ipsum undo congue
                        ...
                        <ul className="list">
                            <li className="paragraph">
                                ...
                                sapien dolor an ultrice ipsum aliquam undo
                                congue dolor cursus
                            </li>

                            <li className="paragraph">
                                Cursus purus suscipit vitae cubilia magnis
                                volute egestas vitae sapien turpis ultrice
                                auctor congue magna placerat
                            </li>
                        </ul>
                    </div>
                </div>
